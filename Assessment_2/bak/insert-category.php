    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content rounded-4 shadow">
        <div class="modal-header p-5 pb-4 border-bottom-0">
          <h1 class="fw-bold mb-0 fs-2">New Category</h1>
        ...
        <div class="modal-body p-5 pt-0">
          ...
          <form class="" action="products.php">
            <div class="form-floating mb-3">
              <input type="text" class="form-control rounded-3" id="floatingCategoryName" placeholder="Category">
              <label for="floatingCategoryName">Category Name</label>
            </div>
            <button class="w-100 mb-2 btn btn-lg rounded-3 btn-primary" type="submit">Add Category</button>
            <hr class="my-4">
          </form>
        </div>
      </div>
