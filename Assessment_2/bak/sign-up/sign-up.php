      ...
      <div class="modal-content rounded-4 shadow">
        ...
        <div class="modal-body p-5 pt-0">
          ...
          >
            ...
            <hr class="my-4">
            <p class="mt-2 mb-5 small"> <em><a href="../sign-in/sign-in.php" class="text-white float-md-start">Already have an account?</a> </em> </p>
...
if (isset($_POST['registerUser'])) {
  ...
  $select_query_cust = "SELECT * FROM `Customer` WHERE customerName = '$fullName' OR customerEmail = '$emailAddress' OR customerPhone = '$phoneNumber' OR customerAddress = '$customerAddress'";
  ...
  if ($select_query_custLogin_result_numRows > 0) {
  ...
  if ($select_query_cust_result_numRows > 0) {
    ...
    echo "<script> alert('Result is- $insert_query_cust_result -') </script>"; // ###
    ...
    echo "<script> alert('Result is- $insert_query_custLogin_result -') </script>"; // ###
