...
<div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
    <h3 class="d-flex align-items-center ps-3"> <?php echo "Hello " .  $_SESSION['loggedInUsername'] ?> </h3>
    <hr class="my-3">

    <ul class="nav flex-column">
        <li class="nav-item">
            <a class="nav-link d-flex align-items-center gap-2 <?php if (isset($_GET['dashboard'])) { echo "active";} ?>" aria-current="page" href="index.php?dashboard">
                <svg class="bi">
