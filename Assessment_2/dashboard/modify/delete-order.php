<?php if (isset($_GET['delete-order'])) {
    $current_Id = $_GET['delete-order'];
    echo 'it is - ', $current_Id;
} ?>
...
<div class="container px-auto align-items-center" style="width: 50%;">
    <form method="post" action="">
        <button class="btn btn-primary w-100 py-2" type="submit" name="deleteOrder">Delete Order</button>
    </form>
</div>
