...
if (isset($_GET['product-id'])) {
  $currentItemId = $_GET['product-id'];
  // echo 'it is - ', $currentItemId;

  $select_query = "SELECT * FROM `item` WHERE itemId = $currentItemId";
...
<body>
  ...
  <div class="modal position-static d-block bg-body-tertiary p-4 py-md-5" tabindex="-1" role="dialog"
    id="modalSignin">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
      <div class="modal-content rounded-4 shadow">
        <div class="modal-header p-5 pb-4 border-bottom-0">
          <h1 class="fw-bold mb-0 fs-2">Place Order</h1>
        ...
        <div class="modal-body p-5 pt-0">
          ...
          <form method="post">
            <div class="form-floating mb-3">
              <input type="text" class="form-control rounded-3" id="itemName" name="itemName" placeholder="John Doe" disabled>
              <label for="itemName"> <?php echo $itemName ?></label>
            </div>
            <div class="form-floating mb-3">
              <input type="email" class="form-control rounded-3" id="itemDescription" name="itemDescription" placeholder="name@example.com" disabled>
              <label for="itemDescription"> <?php echo $itemDescription ?></label>
            </div>
            <div class="form-floating mb-3">
              <input type="number" class="form-control rounded-3" id="itemQuantity" name="itemQuantity" placeholder="+44" required>
              <label for="itemQuantity">Quantity</label>
            </div>


            <!-- <input type="text" class="form-control rounded-3" id="customerSelected" name="customerSelected" placeholder="Home" required>
            <label for="customerSelected">Customer Id</label> -->
            ...
            if ($userType == "employee") {
              ...
              <div class="form-floating mb-3">
                ...
                <option value="" selected>--- Ordering for Customer: ---</option>';
            ...
            <hr class="my-4">
            <button class="w-100 mb-2 btn btn-lg rounded-3 btn-primary form-control" type="submit" name="placeOrder">Order</button>
...
if (isset($_POST['placeOrder'])) {
  ...
  if ($itemQuantity >= 1) {
    if ($userType == "employee") {
      ...
      $customerSelected = $loggedInId;
    }

    // Call procedure to create sale
    $procedure_query = "CALL create_sale('$loggedInId', '$loggedInUserPrivilegeLevel', '$customerSelected', '$itemId', '$itemQuantity')";
